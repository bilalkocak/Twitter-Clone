<?php include('php/anasayfacerceveust.php')  ?>
...
<div class="LogOut-sag">                  
    <div class="LogOut-sag-signup">
        ...
        <form action="php/girisyap.php" method="post">
            ...
            <div class="signup-button">
                ...
                <div>
                    <p>Hesabın yok mu? <a href="php/kayitol.php" class="giris">Kayıt Ol</a></p>
                </div>
            </div>
        </form>
    </div>
...
<?php include('php/anasayfacercevealt.php')  ?>