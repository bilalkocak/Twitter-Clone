    ...
    <div class="LogOut-sag-signup">
        ...
        <form action="kayit.php" method="post">
            ...
            <div class="signup-adsoyad">
                <input type="text" class="txtbox-kayit-adsoyad" name="uye_adi"  placeholder="İsim">
           ...
           <div class="signup-sifre">
            ...
            <div class="signup-button">
                ...
                <div>
                    <p>Hesabın var mı? <a href="http://localhost/Twitter/index.php" class="giris">Giriş Yap</a></p>
                </div>
            </div>
        </form>
    </div>
